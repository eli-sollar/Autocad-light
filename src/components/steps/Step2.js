...
const Step2 = (props) => {
  ...
  const [zeroPointAbsolute, setZeroPointAbsolute] = useState({
    x: 0,
    y: 0,
    direction: "up",
    maxYRange: 0,
        ...
        <Row>
          <form onSubmit={handleSubmit} id="step2">
            ...
            <div className="counter d-flex justify-content-end">
              ...
              {counter.map((el) => (
                <span className="bg-orange p-1  border border-dark px-2">
                  {el}
                </span>
              ))}
            </div>
                  ...
                  <Col>
                    <>
                      <div className="d-flex justify-content-center mt-3">
                        <span className="ms-3">זווית הגג ביחס לקרקע</span>
            ...
            <p className="text-center p-3">
              אחרי סיום שרטוט הגג לחץ על הכפתור בחר וסמן את ראשית הצירים של הגג
              בדרך כלל הנקודה השמאלית התחתונה. ובסיום לחץ על כתפור אישור.
            </p>
            ...
            <div className="d-flex justify-content-around">
              ...
              <button
                ...
                onClick={absoluteZeroPointHandler}
              >
                {absoluteZeroPointText}
              </button>
            </div>
